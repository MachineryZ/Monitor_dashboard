    ...
    while True:
        if os.path.exists(file_path):
            try:
                ...
                select_df = select_df.style.map(red_cells, subset=["cnif_melt_position_diff"]).map(yellow_cells, subset=["signal_5m_diff","signal_30m_diff","signal_1m_diff"])
